...
import { CalendarCheck, Info, Warning } from '@phosphor-icons/react';
        ...
        {estado === 'listo' && (
          <Switch
            ...
            onCheckedChange={(activar) => {
              void guardar(activar ? DEFAULT_AVAILABILITY_SCHEDULE : null);
            }}
          />
        )}
      </header>
