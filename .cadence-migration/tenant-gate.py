import os, re
ROOTS=["src/app/inquilino","src/components/tenant","src/components/score","src/components/contract","src/components/lease"]
fams = {
...
print(f"[{len(files)} tsx across inquilino + tenant/score/contract/lease]")
