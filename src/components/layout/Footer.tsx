...
const socialLinks = [
  {
    name: "X",
    href: "https://x.com/arriendofacil",
    target: "_blank",
  ...
  {
    name: "Facebook",
    href: "https://facebook.com/arriendofacil",
    target: "_blank",
    rel: "noopener noreferrer",
    icon: (
      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "Instagram",
    href: "https://instagram.com/arriendofacil",
    target: "_blank",
    rel: "noopener noreferrer",
    icon: (
      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="mx-auto max-w-[1356px] px-8 pt-[80px]">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-20">
          ...
          >
            ...
            >
              ...
              <button
                type="submit"
                className="h-[44px] px-[20px] bg-white text-primary rounded-r-[2px] text-[15px] tracking-[-0.15px] hover:bg-white/90 transition-colors"
              >
                Suscribir
              </button>
            </form>
        ...
        <div className="border-t border-white/10 py-[24px] flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-[14px] tracking-[-0.28px] text-white/40">
            © {new Date().getFullYear()} Arriendo Facil. Todos los derechos reservados.
          </p>
