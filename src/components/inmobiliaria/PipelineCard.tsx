      ...
      <div className="p-3">
        ...
        <div className="flex items-start gap-2.5 mb-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-sm font-semibold text-neutral-900 dark:text-white mt-0.5">
              {formatCurrency(item.monthlyRent)}<span className="text-xs font-normal text-neutral-400">/mes</span>
            </p>
          </div>
        </div>
        ...
        <div className="space-y-2">
          ...
          <div className={cn(
            ...
            <span>
              {item.daysInStage} {item.daysInStage === 1 ? 'día' : 'días'} en etapa
            </span>
        ...
        <div className="flex items-center justify-between mt-3 pt-3 border-t border-neutral-100 dark:border-neutral-800">
          ...
          <div className="flex items-center gap-1 text-[10px] text-neutral-400">
            ...
            <span className="truncate max-w-[80px]">Agente #{item.agenteId.slice(-3)}</span>
          </div>
        </div>
      </div>
    </motion.div>
