...
export const MOCK_ACTIVITIES: Activity[] = [
  {
    ...
    description: 'Carlos Mendez aplico para Apartamento en Chapinero',
  ...
  },
  {
    ...
    description: 'Maria Garcia fue pre-aprobada para Casa en Usaquen',
    timestamp: hoursAgo(5),
    propertyId: 'prop-002',
    propertyTitle: 'Casa en Usaquen',
  ...
  },
  {
    ...
    type: 'message',
    title: 'Nuevo mensaje',
    description: 'Juan Rodriguez envio un mensaje sobre documentos',
  ...
  },
  {
    ...
    description: 'Ana Lopez subio comprobante de ingresos',
    timestamp: daysAgo(1),
    propertyId: 'prop-006',
  ...
  },
  {
    ...
    type: 'application',
    title: 'Nueva aplicacion',
    description: 'Pedro Sanchez aplico para Casa en Usaquen',
    timestamp: daysAgo(1),
    propertyId: 'prop-002',
    propertyTitle: 'Casa en Usaquen',
  ...
  },
  {
    ...
    description: 'Sofia Martinez fue aprobada para Casa en Usaquen',
    timestamp: daysAgo(2),
    propertyId: 'prop-002',
    propertyTitle: 'Casa en Usaquen',
