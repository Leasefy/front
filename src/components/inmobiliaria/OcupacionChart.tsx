  ...
  return (
    <div className={cn('space-y-6', className)}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Donut Chart */}
        <div className="lg:col-span-1 flex flex-col items-center justify-center p-6 rounded-xl border border-border dark:border-border-strong bg-surface dark:bg-[#14130F]">
      ...
      {/* Zone Breakdown */}
      {viewVariant === 'chart' ? (
        <div className="space-y-6 p-6 rounded-xl border border-border dark:border-border-strong bg-surface dark:bg-[#14130F]">
