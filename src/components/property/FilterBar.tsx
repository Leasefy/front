    ...
    <div className="bg-white border-b border-gray-200 z-40">
      <div className="px-4 lg:px-6 py-3">
        <div className="flex items-center gap-2 flex-wrap">
          ...
          {/* More Filters Button */}
          <button
            className="flex items-center gap-2 px-4 py-2 text-sm border border-gray-300 rounded-sm hover:bg-gray-50 transition-colors"
          >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute top-full left-0 mt-2 bg-white rounded-sm shadow-lg border border-gray-200 z-50 max-h-64 overflow-auto origin-top-left"
          >
            {children}
          </motion.div>
        )}
