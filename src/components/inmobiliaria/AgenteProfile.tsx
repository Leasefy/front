      ...
      <div className="p-5 lg:p-6">
        ...
        <div className="flex flex-wrap gap-2 mb-6">
          ...
          <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-neutral-100 dark:bg-neutral-800 text-sm text-neutral-700 dark:text-neutral-300">
            ...
            Desde {formatDate(agente.hireDate)}
          </div>
        </div>
          ...
          <div className="flex items-center justify-between text-sm">
            <div className="flex items-center gap-2">
              ...
              <span className="text-neutral-600 dark:text-neutral-400">
                Agente: <span className="font-semibold text-neutral-900 dark:text-white">{agentPercent}%</span>
              </span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-3 h-3 rounded-full bg-neutral-400 dark:bg-neutral-500" />
              <span className="text-neutral-600 dark:text-neutral-400">
                Inmobiliaria: <span className="font-semibold text-neutral-900 dark:text-white">{agencyPercent}%</span>
              </span>
            </div>
          </div>
        </div>
