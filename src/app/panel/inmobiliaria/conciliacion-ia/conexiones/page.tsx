...
const ENTRADAS: Conexion[] = [
  ...
  { icon: Receipt, modulo: 'Cartera y facturas', ejemplo: 'Sabe qué facturas están pendientes o vencidas para cada inquilino.', tipo: 'auto', href: '/panel/inmobiliaria/pagos/cartera/cobros' },
]
...
const SALIDAS: Conexion[] = [
  ...
  { icon: ChatCircleText, modulo: 'Cobranza IA', ejemplo: 'Si queda saldo o no hay pago, activa la cobranza por el monto exacto.', tipo: 'auto', href: '/panel/inmobiliaria/pagos/cobranza' },
