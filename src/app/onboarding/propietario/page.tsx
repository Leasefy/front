        ...
        >
          ...
          <div className="space-y-3">
            {returnUrl ? (
              <Link
                href={returnUrl}
                className="flex items-center justify-center gap-2 w-full py-3.5 px-6 bg-foreground text-background font-semibold rounded-xl hover:bg-foreground/90 transition-colors"
              >
              ...
              <>
                ...
                <Link
                  href="/panel"
                  className="flex items-center justify-center gap-2 w-full py-3.5 px-6 bg-card text-muted-foreground font-medium rounded-xl border border-border hover:bg-muted transition-colors"
                >
                  Ir al panel
                </Link>
              </>
          ...
          {step === 1 ? (
            ...
            >
              ...
              <div className="space-y-6">
                ...
                <div>
                  <label className="block text-sm font-medium text-foreground mb-2">
                    Celular <span className="text-muted-foreground/70 font-normal">(opcional)</span>
                  </label>
                  <input
                    type="tel"
                    inputMode="numeric"
            ...
            >
              ...
              <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {PROPERTY_TYPES.map((type) => (
                      ...
                      >
                        ...
                        <span className={cn(
                          "font-medium",
                          data.propertyTextT === type.value ? "text-foreground" : "text-muted-foreground"
                        )}>
                          {type.label}
                        </span>
                      </button>
                ...
                <div>
                  <label className="block text-sm font-medium text-foreground mb-2">
                    Arriendo esperado <span className="text-muted-foreground/70 font-normal">(opcional)</span>
                  </label>
                  <div className="relative">
                    <span className="absolute left-4 top-1/2 -translate-y-1/2 text-muted-foreground/70">$</span>
                    <input
                      type="text"
                      ...
                      className="w-full pl-8 pr-20 py-3.5 text-base rounded-xl border border-input bg-card text-foreground placeholder:text-muted-foreground/70 focus:outline-none focus:ring-2 focus:ring-foreground/10 focus:border-foreground/40 transition-all"
                    />
                    <span className="absolute right-4 top-1/2 -translate-y-1/2 text-muted-foreground/70 text-sm">/mes</span>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-8 p-4 bg-muted rounded-xl">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-foreground">Tu propiedad está protegida</p>
