...
//   - /panel/inmobiliaria/pagos/cobranza/pagos                       (funnel)
//   - /panel/inmobiliaria/pagos/cobranza/pagos/planes/[planId]       (plan approval)
//   - /panel/inmobiliaria/pagos/cobranza/siniestros/[id]             (siniestro approval)
//   - /panel/inmobiliaria/pagos/cobranza/cartas/[id]                 (carta approval)
//   - /panel/inmobiliaria/pagos/cobranza/pagos/[paymentId]           (read-only detail)
//
...
test.describe('phase 32 cobranza approvals visual regression', () => {
  test('pagos funnel — KPI strip + table + ⚠ pill', async ({ page }) => {
    ...
    await page.goto('/panel/inmobiliaria/pagos/cobranza/pagos')
  ...
  test('payment plan approval — within limit, Aprobar enabled', async ({ page }) => {
    ...
    await page.goto(`/panel/inmobiliaria/pagos/cobranza/pagos/planes/${PLAN_ID}`)
    await page.waitForLoadState('networkidle')
    await page
  ...
  test('siniestro approval page', async ({ page }) => {
    ...
    await page.goto(`/panel/inmobiliaria/pagos/cobranza/siniestros/${CLAIM_ID}`)
    await page.waitForLoadState('networkidle')
    await page
  ...
  test('carta approval page', async ({ page }) => {
    ...
    await page.goto(`/panel/inmobiliaria/pagos/cobranza/cartas/${CARTA_ID}`)
    await page.waitForLoadState('networkidle')
    await page
  ...
  test('payment read-only detail page', async ({ page }) => {
    ...
    await page.goto(`/panel/inmobiliaria/pagos/cobranza/pagos/${PAYMENT_ID}`)
    await page.waitForLoadState('networkidle')
    await page
