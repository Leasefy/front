...
const features = [
  {
    icon: (
      <svg className="w-10 h-10 text-gray-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="0.75">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-stretch">
          ...
          <div>
            ...
            <div className="flex items-center gap-4 mb-8">
              <span className="flex items-center gap-2 text-xs text-gray-500 tracking-tight whitespace-nowrap">
            ...
            {/* Heading */}
            <h2 className="text-[40px] lg:text-[48px] font-normal text-gray-900 leading-[1.1] tracking-[-0.02em] mb-6">
