...
const CLAVES_DE_INQUILINOS = [
  ...
  'estados.terminado',
  'estados.cancelado',
  // El cajón de detalle (2026-09-03). Reemplazó a `ficha.*`, que era el
  // diálogo chico, y a `verFicha`, que era el botón de la columna que se fue.
  'cajon.canonVigente',
  // Lo que debe sale del ESTADO DE CUENTA desde el 2026-09-16, no de sumar
  // cobros: con las palabras de Pagos y Cartera.
  'cajon.restaPorPagar',
  'cajon.proximaCuota',
  'cajon.vencidoSinPagar',
  'cajon.alDia',
  'cajon.vencidoEnPlazo',
  'cajon.enCartera',
  'cajon.enCarteraUnDia',
  'cajon.errorCuenta',
  'cajon.sinEstadoDeCuenta',
  'cajon.verEstadoDeCuenta',
  'cajon.arriendos',
  'cajon.arriendosIncluyeTerminados',
  'cajon.cargandoArriendos',
  'cajon.arriendosIncompletos',
  'cajon.verContrato',
  'cajon.cobrosEmitidos',
  'cajon.pagosDeSusContratos',
  'cajon.cargandoPagos',
  'cajon.errorPagos',
  'cajon.pagosIncompletos',
  'cajon.sinCobrosTitulo',
  'cajon.sinCobros',
  'cajon.sinContratos',
  'cajon.reintentar',
  'cajon.ultimoPago',
