      ...
      <div className="min-h-screen bg-background flex items-center justify-center p-6">
        ...
        >
          <div className="w-20 h-20 bg-indigo-100 dark:bg-indigo-900/40 rounded-full flex items-center justify-center mx-auto mb-6">
            <Check className="w-10 h-10 text-indigo-600 dark:text-indigo-400" strokeWidth={2.5} />
          </div>
          ...
          <div className="mt-8 p-4 bg-card rounded-xl border border-border">
            <p className="text-sm font-medium text-foreground mb-3">{t('inmobiliaria.onboarding.register.success.planIncludes')}</p>
            <div className="grid grid-cols-2 gap-3 text-left">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs text-muted-foreground">{t('inmobiliaria.onboarding.register.success.ownerManagement')}</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 bg-emerald-50 dark:bg-emerald-950/30 rounded-lg flex items-center justify-center">
                  <Buildings className="w-4 h-4 text-emerald-600 dark:text-emerald-400" />
                </div>
                <span className="text-xs text-muted-foreground">{t('inmobiliaria.onboarding.register.success.unlimitedPortfolio')}</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 bg-amber-50 dark:bg-amber-950/30 rounded-lg flex items-center justify-center">
                  <ChartLineUp className="w-4 h-4 text-amber-600 dark:text-amber-400" />
                </div>
                <span className="text-xs text-muted-foreground">{t('inmobiliaria.onboarding.register.success.reportsAnalytics')}</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 bg-rose-50 dark:bg-rose-950/30 rounded-lg flex items-center justify-center">
                  <Shield className="w-4 h-4 text-rose-600 dark:text-rose-400" />
                </div>
                <span className="text-xs text-muted-foreground">{t('inmobiliaria.onboarding.register.success.tenantVerification')}</span>
              </div>
            </div>
          </div>
        </motion.div>
        ...
        <div className="max-w-2xl mx-auto px-6">
          <div className="flex items-center justify-between h-16">
            <Link href="/" className="flex items-center gap-2">
              <svg viewBox="0 0 207 60" className="h-6 w-auto text-foreground" fill="none">
                ...
                {(fromPublish ? [1, 4] : [1, 2, 3, 4]).map((s, idx, arr) => (
                  <div key={s} className="flex items-center gap-2">
                    <div className={cn(
                      ...
                      step === s ? "bg-indigo-600 text-white uppercase tracking-wide font-mono" : "bg-muted text-muted-foreground"
                    )}>
                    ...
                    {idx < arr.length - 1 && (
                      <div className={cn(
                        ...
                        step > s ? "bg-indigo-600" : "bg-border"
                      )} />
                    )}
                  </div>
                ))}
        ...
        <AnimatePresence mode="wait">
          {step === 1 && (
            ...
            >
              ...
              <div className="text-center mb-10">
                <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-indigo-50 dark:bg-indigo-950/30 text-indigo-600 dark:text-indigo-400 rounded-full text-sm font-medium mb-4">
              ...
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3.5 text-base rounded-xl border border-input bg-card text-foreground placeholder:text-muted-foreground/70 focus:outline-none focus:ring-2 focus:ring-foreground/10 focus:border-foreground/40 transition-all"
                  />
                </div>
                ...
                <div>
                  <label className="block text-sm font-medium text-foreground mb-2">
                    {t('inmobiliaria.onboarding.register.step1.nit')} <span className="text-muted-foreground/70 font-normal">({t('common.optional')})</span>
                  </label>
                  <input
                    type="text"
                    value={data.nit}
                ...
                <div>
                  <label className="block text-sm font-medium text-foreground mb-2">
                    {t('inmobiliaria.onboarding.register.step1.phone')} <span className="text-muted-foreground/70 font-normal">({t('common.optional')})</span>
                  </label>
                  <input
                    type="tel"
                    inputMode="numeric"
                    ...
                    className={cn(
                      "w-full px-4 py-3.5 text-base rounded-xl border bg-card text-foreground placeholder:text-muted-foreground/70 focus:outline-none focus:ring-2 focus:ring-foreground/10 transition-all",
                      data.phone && data.phone.replace(/\s/g, '').length > 0 && data.phone.replace(/\s/g, '').length < 10
                        ? "border-amber-300 focus:border-amber-400"
                        : "border-input focus:border-foreground/40"
                    )}
                  />
          ...
          {step === 2 && (
            ...
            >
              {/* Step 2: Business Details */}
              <div className="text-center mb-10">
                <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-emerald-50 dark:bg-emerald-950/30 text-emerald-600 dark:text-emerald-400 rounded-full text-sm font-medium mb-4">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3.5 text-base rounded-xl border border-input bg-card text-foreground focus:outline-none focus:ring-2 focus:ring-foreground/10 focus:border-foreground/40 transition-all appearance-none"
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {PORTFOLIO_SIZES.map((size) => (
                      ...
                      >
                        <span className={cn(
                          "font-medium text-sm",
                          data.portfolioSize === size.value ? "text-foreground" : "text-muted-foreground"
                        )}>
                          {size.label}
                        </span>
                        <span className="text-xs text-muted-foreground/70 mt-0.5">{size.description}</span>
                      </button>
                    ))}
                  </div>
                </div>
                ...
                <div>
                  <label className="block text-sm font-medium text-foreground mb-2">
                    {t('inmobiliaria.onboarding.register.step2.yearsInBusiness')} <span className="text-muted-foreground/70 font-normal">({t('common.optional')})</span>
                  </label>
                  <input
                    type="number"
                    min="0"
              ...
              <div className="flex gap-3 mt-10">
                <button
                  type="button"
                  onClick={handleBack}
                  className="flex items-center justify-center gap-2 px-6 py-4 rounded-xl border border-border text-muted-foreground font-medium hover:bg-muted transition-colors"
                >
          ...
          {step === 3 && (
            ...
            >
              {/* Step 3: Services */}
              <div className="text-center mb-10">
                <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-amber-50 dark:bg-amber-950/30 text-amber-600 dark:text-amber-400 rounded-full text-sm font-medium mb-4">
              ...
              <div className="space-y-6">
                ...
                <div className="p-4 bg-indigo-50 dark:bg-indigo-950/30 rounded-xl">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-foreground">{t('inmobiliaria.onboarding.register.step3.trustBadgeTitle')}</p>
              ...
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <div className="relative">
                    <Envelope className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-muted-foreground/70" />
                    <input
                      type="email"
                      value={data.email}
                      onChange={(e) => updateData({ email: e.target.value })}
                      placeholder={t('inmobiliaria.onboarding.register.step4.emailPlaceholder')}
                      className="w-full pl-12 pr-4 py-3.5 text-base rounded-xl border border-input bg-card text-foreground placeholder:text-muted-foreground/70 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-12 pr-12 py-3.5 text-base rounded-xl border border-input bg-card text-foreground placeholder:text-muted-foreground/70 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all"
                    />
                    <button
                      type="button"
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={cn(
                        "w-full pl-12 pr-12 py-3.5 text-base rounded-xl border bg-card text-foreground placeholder:text-muted-foreground/70 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 transition-all",
