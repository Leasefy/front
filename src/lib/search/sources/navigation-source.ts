...
const NAV_CATALOG: NavEntry[] = [
  ...
  { kind: 'page', title: 'Extracto bancario', context: 'Finanzas', href: '/panel/inmobiliaria/ai/conciliacion/movimientos', keywords: 'conciliacion bancaria extracto banco movimientos recibos automaticos', permission: { module: 'cobros', action: 'view' } },
