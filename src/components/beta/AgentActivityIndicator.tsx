      ...
      <div className="flex items-center gap-3 py-2 px-1">
        ...
        <span
          className={cn(
            ...
            agent.status === 'failed' && 'text-danger/70 line-through',
        ...
        <div className="w-4 h-4 flex items-center justify-center shrink-0">
          ...
          {agent.status === 'failed' && (
            <XCircle className="w-4 h-4 text-danger" weight="fill" />
          )}
        </div>
          ...
          <div className="flex items-center gap-2">
            <Sparkle
              className={cn(
                'w-4 h-4',
                allCompleted
                  ? hasFailure ? 'text-danger' : 'text-success'
        ...
        <div className="h-1 rounded-full bg-neutral-100 dark:bg-neutral-800 mb-3 overflow-hidden">
          <div
            className={cn(
              ...
              allCompleted
                ? hasFailure ? 'bg-danger' : 'bg-success'
