...
- 🚧 **v6.0 Backoffice Unificado ERP·CRM·Autopilot** - Phases v6-01..v6-08 (frontend-first; v6-01..v6-03 ✅) → detalle en `milestones/v6.0-ROADMAP.md`, backbone en `ERP-CRM-AUTOPILOT-PROGRAM.md`. **Namespace `v6-NN`** para no colisionar con el stream `agent` v2.1-frontend (29→37+) que también commitea en mvp.
