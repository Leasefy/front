...
const TENANT_SEARCH_DATA: SearchResult[] = [
  // Applications
  {
    ...
    subtitle: 'Aplicación en revisión',
    category: 'application',
    href: '/inquilino/aplicaciones',
  },
  {
    id: 'app-2',
    title: 'Studio Zona Rosa',
    subtitle: 'Aplicación pre-aprobada',
    category: 'application',
    href: '/inquilino/aplicaciones',
  },
  // Payments
  {
    id: 'pay-1',
    title: 'Pago Febrero 2026',
    subtitle: '$2,500,000 - Pendiente',
    category: 'payment',
    href: '/inquilino/pagos',
  },
  {
    id: 'pay-2',
    title: 'Pago Enero 2026',
    subtitle: '$2,500,000 - Pagado',
    category: 'payment',
    href: '/inquilino/pagos',
  },
  // Documents
  {
    ...
    subtitle: 'PDF - Firmado',
    category: 'document',
    href: '/inquilino/documentos',
  },
  {
    id: 'doc-2',
    title: 'Recibo Enero 2026',
    subtitle: 'PDF - Disponible',
    category: 'document',
    href: '/inquilino/documentos',
  },
  // Lease
  {
    id: 'lease-1',
    title: 'Mi Arriendo Actual',
    subtitle: 'Apartamento 501 - Chapinero',
    category: 'lease',
...
const LANDLORD_SEARCH_DATA: SearchResult[] = [
  ...
  {
    id: 'prop-1',
    title: 'Apartamento Chapinero Alto',
    subtitle: 'Calle 85 #15-23 - 5 candidatos',
    category: 'property',
    href: '/panel/prop-001',
  },
  {
    id: 'prop-2',
    title: 'Studio Zona Rosa',
    subtitle: 'Carrera 13 #82-15 - 3 candidatos',
    category: 'property',
    href: '/panel/prop-002',
  },
  {
    id: 'prop-3',
    title: 'Casa Cedritos',
    subtitle: 'Calle 140 #10-45 - 2 candidatos',
    category: 'property',
    href: '/panel/prop-003',
  },
  // Candidates
  {
    id: 'cand-1',
    title: 'María García',
    subtitle: 'Riesgo A - Chapinero Alto',
    category: 'candidate',
    href: '/panel/prop-001',
  },
  {
    id: 'cand-2',
    title: 'Juan Pérez',
    subtitle: 'Riesgo B - Studio Zona Rosa',
    category: 'candidate',
    href: '/panel/prop-002',
  },
  {
  ...
  },
  {
    id: 'cand-4',
    title: 'Pedro López',
    subtitle: 'Riesgo C - Casa Cedritos',
    category: 'candidate',
    href: '/panel/prop-003',
  },
  // Contracts
  {
    id: 'cont-1',
    title: 'Contrato María García',
    subtitle: 'Pendiente firma - Chapinero Alto',
    category: 'contract',
    href: '/panel/contratos',
  },
  {
    id: 'cont-2',
    title: 'Contrato Luis Rodríguez',
    subtitle: 'Activo - Studio Zona Rosa',
    category: 'contract',
    href: '/panel/contratos',
  },
  // Leases
  {
    id: 'lease-1',
    title: 'Arriendo Apartamento 501',
    subtitle: 'Laura Sánchez - $2,500,000/mes',
    category: 'lease',
    href: '/panel/leases',
  },
  {
  ...
  {
    id: 'pay-1',
    title: 'Pago Laura Sánchez',
    subtitle: '$2,500,000 - Recibido Feb 2026',
    category: 'payment',
    href: '/panel/leases',
  },
  {
...
const CATEGORY_ORDER_TENANT: SearchCategory[] = [
  'application',
  'lease',
  'payment',
  'document',
...
const CATEGORY_ORDER_LANDLORD: SearchCategory[] = [
  'property',
  'candidate',
  'contract',
  'lease',
