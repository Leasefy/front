...
import { ChatCircle, MagnifyingGlass, PaperPlaneTilt, Paperclip, DotsThreeVertical, Check, Checks, Info, Image, Smiley, ArrowLeft, X, House, Envelope, Archive, BellSlash, TrashSimple, Flag } from '@phosphor-icons/react';
...
export default function MensajesPage() {
  ...
  // List Actions (placeholder - could be wired to backend later)
  const handleArchive = () => {
    setShowOptionsList(false);
                    ...
                    <EmptyState
                      ...
                      description={
                        searchQuery
                          ...
                          : 'Cuando recibas aplicaciones y te comuniques con inquilinos, tus conversaciones apareceran aqui.'
                      }
                    />
                  </div>
                ) : (
              ...
              {!selectedConversation ? (
                <div className="flex-1 flex items-center justify-center">
                  <EmptyState
                    ...
                    description="Selecciona una conversacion para ver los mensajes."
                  />
                </div>
              ) : (
                <>
