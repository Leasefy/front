...
import { SquaresFour, House, FileMagnifyingGlass, Handshake, CreditCard, FileText, Chat, MagnifyingGlass, Bell, UserCircle, Gear, ClipboardText, Lifebuoy } from '@phosphor-icons/react';
