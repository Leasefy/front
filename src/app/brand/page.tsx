  ...
  return (
    <div className="rounded-xl border border-neutral-200 bg-white overflow-hidden">
      ...
      <div className="px-4 py-2.5 border-t border-neutral-200">
        <span className="font-mono text-[10.5px] font-medium uppercase tracking-[0.08em] text-neutral-500">{label}</span>
      </div>
    </div>
  );
}
      ...
      <div className="max-w-[1100px] mx-auto px-8 py-14">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="rounded-xl border border-neutral-200 overflow-hidden">
            ...
            <div className="px-4 py-2.5 border-t border-neutral-200">
              <span className="font-mono text-[10.5px] font-medium uppercase tracking-[0.08em] text-neutral-500">Hero · headline blanco + azul</span>
            </div>
          </div>
          ...
          <div className="rounded-xl border border-neutral-200 overflow-hidden">
            ...
            <div className="px-4 py-2.5 border-t border-neutral-200">
              <span className="font-mono text-[10.5px] font-medium uppercase tracking-[0.08em] text-neutral-500">Hero KPI · contour (grammar de badge)</span>
            </div>
          </div>
        </div>
