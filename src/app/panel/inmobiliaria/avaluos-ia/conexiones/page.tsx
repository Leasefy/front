...
const SALIDAS: Conexion[] = [
  ...
  { icon: ChatCircleText, modulo: 'Cobranza IA', ejemplo: 'Al arrendarse, el canon entra al recaudo mensual de cobranza.', tipo: 'auto', href: '/panel/inmobiliaria/pagos/cobranza' },
