...
//   - /panel/inmobiliaria/pagos/cobranza/deudores              (list, default sort days_in_stage DESC)
//   - /panel/inmobiliaria/pagos/cobranza/deudores/[id]         (debtor detail, Timeline tab active)
//   - /panel/inmobiliaria/pagos/cobranza/llamadas/[callId]     (call detail, audio + transcript)
//
...
test.describe('phase 31 cobranza visual regression', () => {
  ...
  test('debtors list — default sort days_in_stage DESC', async ({ page }) => {
    await page.goto('/panel/inmobiliaria/pagos/cobranza/deudores')
  ...
  test('debtor detail — Timeline tab active, bottom-drawer at sm', async ({ page }) => {
    await page.goto(`/panel/inmobiliaria/pagos/cobranza/deudores/${DEBTOR_ID}`)
  ...
  test('call detail — audio + transcript, sticky-top audio at sm', async ({ page }) => {
    await page.goto(`/panel/inmobiliaria/pagos/cobranza/llamadas/${CALL_ID}`)
