/**
 * Colombia geographic reference data (DIVIPOLA / DANE).
 *
 * 33 departamentos (32 official + Bogotá D.C. capital district)
 * and 1103 municipios. Vendored static reference data — same rationale as
 * IPC_HISTORICAL in inmobiliaria-data.ts (no runtime dependency, does not change
 * often). Source: DIVIPOLA via github.com/marcovega/colombia-json, plus Bogotá D.C.
 *
 * DO NOT edit by hand — regenerate from the source if DIVIPOLA changes.
 */

export interface DepartamentoGeo {
  /** Departamento name, DIVIPOLA spelling. */
  nombre: string
  /** Municipios of this departamento, alphabetically sorted (es-CO). */
  municipios: readonly string[]
}

/** All departamentos, alphabetically sorted (es-CO). */
export const COLOMBIA_DEPARTAMENTOS: readonly DepartamentoGeo[] = [
  ...
  { nombre: "Atlántico", municipios: ["Baranoa", "Barranquilla", "Campo de la Cruz", "Candelaria", "Galapa", "Juan de Acosta", "Luruaco", "Malambo", "Manatí", "Palmar de Varela", "Piojó", "Polonuevo", "Ponedera", "Puerto Colombia", "Repelón", "Sabanagrande", "Sabanalarga", "Santa Lucía", "Santo Tomás", "Soledad", "Suán", "Tubará", "Usiacurí"] },
  ...
  { nombre: "Cesar", municipios: ["Aguachica", "Agustín Codazzi", "Astrea", "Becerril", "Bosconia", "Chimichagua", "Chiriguaná", "Curumaní", "El Copey", "El Paso", "Gamarra", "González", "La Gloria (Cesar)", "La Jagua de Ibirico", "La Paz", "Manaure Balcón del Cesar", "Pailitas", "Pelaya", "Pueblo Bello", "Río de Oro", "San Alberto", "San Diego", "San Martín", "Tamalameque", "Valledupar"] },
  { nombre: "Chocó", municipios: ["Acandí", "Alto Baudó", "Bagadó", "Bahía Solano", "Bajo Baudó", "Bojayá", "Cantón de San Pablo", "Cértegui", "Condoto", "El Atrato", "El Carmen de Atrato", "El Carmen del Darién", "Istmina", "Juradó", "Litoral de San Juan", "Lloró", "Medio Atrato", "Medio Baudó", "Medio San Juan", "Nóvita", "Nuquí", "Quibdó", "Río Iró", "Río Quito", "Riosucio", "San José del Palmar", "Sipí", "Tadó", "Unguía", "Unión Panamericana"] },
  ...
  { nombre: "Cundinamarca", municipios: ["Agua de Dios", "Albán", "Anapoima", "Anolaima", "Apulo", "Arbeláez", "Beltrán", "Bituima", "Bojacá", "Cabrera", "Cachipay", "Cajicá", "Caparrapí", "Cáqueza", "Carmen de Carupa", "Chaguaní", "Chía", "Chipaque", "Choachí", "Chocontá", "Cogua", "Cota", "Cucunubá", "El Colegio", "El Peñón", "El Rosal", "Facatativá", "Fómeque", "Fosca", "Funza", "Fúquene", "Fusagasugá", "Gachalá", "Gachancipá", "Gachetá", "Gama", "Girardot", "Granada", "Guachetá", "Guaduas", "Guasca", "Guataquí", "Guatavita", "Guayabal de Síquima", "Guayabetal", "Gutiérrez", "Jerusalén", "Junín", "La Calera", "La Mesa", "La Palma", "La Peña", "La Vega", "Lenguazaque", "Machetá", "Madrid", "Manta", "Medina", "Mosquera", "Nariño", "Nemocón", "Nilo", "Nimaima", "Nocaima", "Pacho", "Paime", "Pandi", "Paratebueno", "Pasca", "Puerto Salgar", "Pulí", "Quebradanegra", "Quetame", "Quipile", "Ricaurte", "San Antonio del Tequendama", "San Bernardo", "San Cayetano", "San Francisco", "San Juan de Rioseco", "Sasaima", "Sesquilé", "Sibaté", "Silvania", "Simijaca", "Soacha", "Sopó", "Subachoque", "Suesca", "Supatá", "Susa", "Sutatausa", "Tabio", "Tausa", "Tena", "Tenjo", "Tibacuy", "Tibirita", "Tocaima", "Tocancipá", "Topaipí", "Ubalá", "Ubaque", "Ubaté", "Une", "Útica", "Venecia", "Vergara", "Vianí", "Villagómez", "Villapinzón", "Villeta", "Viotá", "Yacopí", "Zipacón", "Zipaquirá"] },
  ...
  { nombre: "Putumayo", municipios: ["Colón", "Mocoa", "Orito", "Puerto Asís", "Puerto Caicedo", "Puerto Guzmán", "Puerto Leguízamo", "San Francisco", "San Miguel", "Santiago", "Sibundoy", "Valle del Guamuez", "Villagarzón"] },
  ...
  { nombre: "Sucre", municipios: ["Buenavista", "Caimito", "Chalán", "Colosó", "Corozal", "Coveñas", "El Roble", "Galeras", "Guaranda", "La Unión", "Los Palmitos", "Majagual", "Morroa", "Ovejas", "Sampués", "San Antonio de Palmito", "San Benito Abad", "San Juan de Betulia", "San Marcos", "San Onofre", "San Pedro", "Sincé", "Sincelejo", "Sucre", "Tolú", "Tolú Viejo"] },
  ...
  { nombre: "Vaupés", municipios: ["Carurú", "Mitú", "Taraira"] },
  { nombre: "Vichada", municipios: ["Cumaribo", "La Primavera", "Puerto Carreño", "Santa Rosalía"] },
] as const

/** Departamento names only — convenience for the departamento combobox options. */
export const DEPARTAMENTO_NOMBRES: readonly string[] = COLOMBIA_DEPARTAMENTOS.map(
  (d) => d.nombre,
)

/**
 * Municipios of a given departamento (by exact DIVIPOLA name). Returns an empty
 * array for an unknown/empty departamento — the dependent municipio combobox
 * renders no options until a valid departamento is chosen.
 */
