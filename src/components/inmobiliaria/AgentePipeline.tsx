                ...
                activeItems.map((item) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="w-12 h-12 rounded-md bg-neutral-200 dark:bg-neutral-700 overflow-hidden shrink-0">
                        {item.propertyThumbnail ? (
                          ...
                          <div className="w-full h-full flex items-center justify-center">
                            <Buildings className="w-5 h-5 text-neutral-400" />
                          </div>
                        )}
                      </div>
                      ...
                      {/* Arrow */}
                      <ArrowRight className="w-4 h-4 text-neutral-300 dark:text-neutral-600 shrink-0 mt-1 group-hover:text-neutral-500 dark:group-hover:text-neutral-400 transition-colors" />
                    </button>
                  );
                })
              ) : (
