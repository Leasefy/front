      ...
      <div className="animate-stagger-in" style={{ animationDelay: '0.16s' }}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            .map((agent) =>
              agent.id === 'tenant-scoring' ? (
                ...
                <div
                  ...
                  onClick={() => router.push('/panel/inmobiliaria/postulaciones/estudio')}
          ...
          {cobranzaAgent && (
            <div
              className="relative cursor-pointer"
              onClick={() => router.push('/panel/inmobiliaria/cobros/cobranza/analitica')}
          ...
          {cotizadorAgent && (
            <div
              className="relative cursor-pointer"
              onClick={() => router.push('/panel/inmobiliaria/postulaciones/asegurabilidad')}
          ...
          {mantenimientoAgent && (
            <div
              className="relative cursor-pointer"
              onClick={() => router.push('/panel/inmobiliaria/mantenimientos/tickets/resumen')}
