...
const CLAVES_EN_USO = [
  ...
  'form.forma.ayuda',
  'form.forma.parteDe',
  'form.forma.abonarTitulo',
  'form.forma.abonarAyuda',
  'form.forma.anticipoTitulo',
  ...
  // El recibo por CLIENTE (2026-09-12): elegir la persona, ver su cartera y
  // ver a qué meses va la plata antes de emitir.
  'form.cliente.label',
  'form.cliente.placeholder',
  'form.cliente.buscar',
  'form.cliente.cargando',
  'form.cliente.fallo',
  'form.cliente.reintentar',
  'form.cliente.sinClientes',
  'form.cartera.cargando',
  'form.cartera.fallo',
  'form.cartera.reintentar',
  'form.cartera.sinDeuda',
  'form.cartera.total',
  'form.cartera.masVieja',
  'form.cartera.variosInmuebles',
  'form.plan.titulo',
  'form.plan.ayuda',
  'form.plan.intereses',
  'form.plan.queda',
  'form.plan.despues',
  'form.plan.sinConciliar',

  // La deuda nace con el contrato (2026-09-15): lo vencido y lo que todavía no
  // vence se nombran por separado, y adelantar se llama adelantar.
  'form.descripcionAdelanto',
  'form.pagaLoVencido',
  'form.adelantoDesde',
  'form.sinMandato',
  ...
  'form.cartera.grupoFuturo',
  'form.cartera.vencida',
  'form.cartera.conMora',
  'form.cartera.noVenceAun',
  'form.cartera.abonado',
  'form.cartera.soloAdelanto',
  // El interés de mora, aparte del capital (2026-09-16).
  'form.cartera.capitalEInteres',
  'form.cartera.deLosCualesIntereses',
  'form.cartera.interesPrimero',
  'form.plan.adelanto',
  'form.plan.hayAdelanto',
...
const CON_PARAMETROS: Record<string, string[]> = {
  ...
  'form.emitido': ['numero'],
  'form.emitidoVarios': ['numeros'],
  'form.emitidoQuedaSaldo': ['monto', 'saldo'],
  'form.emitidoSinSaldo': ['monto'],
  'form.cartera.sinDeuda': ['nombre'],
  'form.cartera.variosInmuebles': ['count'],
  'form.cartera.capitalEInteres': ['capital', 'intereses'],
  'form.cartera.deLosCualesIntereses': ['monto'],
  'form.adelantoDesde': ['vencido', 'futuro'],
  'form.cartera.conMora': ['dias'],
  'form.cartera.noVenceAun': ['fecha'],
  'form.cartera.abonado': ['monto'],
  'form.cartera.soloAdelanto': ['nombre'],
  'form.plan.intereses': ['intereses', 'capital'],
  'form.plan.queda': ['monto'],
