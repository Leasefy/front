...
import { SquaresFour, House, FileMagnifyingGlass, Handshake, CreditCard, FileText, Chat, MagnifyingGlass, Bell, UserCircle, Gear, ClipboardText, Lifebuoy, Scroll } from '@phosphor-icons/react';
