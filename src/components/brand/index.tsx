/**
 * Leasefy brand signatures — THIN SHIM over @leasefy/ui.
 *
 ...
 * touching 60+ call sites. New code may import '@leasefy/ui' directly.
 *
 ...
 *  - Ink #0B1220 = the ONE brand-hero surface per screen (contour + glow).
...
export type { SemanticTone } from "@leasefy/ui";
