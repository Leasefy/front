                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between gap-2">
                      ...
                      <span className="inline-flex items-center justify-center min-w-6 h-6 px-2 rounded-full bg-surface-muted text-[12.5px] font-semibold tabular-nums text-fg-muted shrink-0">
                        {t.count}
                      </span>
                    </div>
                    <p className="mt-1 text-[12.5px] text-fg-muted leading-snug">{t.desc}</p>
                    <div className="mt-3 flex items-center justify-between">
                      <span className="font-mono text-[11px] text-fg-subtle tabular-nums">{fmt(t.valor)}</span>
