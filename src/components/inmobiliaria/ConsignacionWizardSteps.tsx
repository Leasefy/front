        ...
        <div className="space-y-1.5">
          ...
          <input
            ...
            className={cn(
              ...
              errors.propertyTitle ? 'border-danger/30' : 'border-neutral-200 dark:border-neutral-700'
            )}
          />
          ...
          <div className="relative">
            ...
            <input
              ...
              className={cn(
                ...
                errors.propertyAddress ? 'border-danger/30' : 'border-neutral-200 dark:border-neutral-700'
              )}
            />
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="space-y-1.5">
            ...
            <input
              ...
              className={cn(
                'w-full px-4 py-2.5 rounded-xl border bg-white dark:bg-[#1a1a1c] text-neutral-900 dark:text-white placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all',
                errors.propertyCity ? 'border-danger/30' : 'border-neutral-200 dark:border-neutral-700'
              )}
            />
            {errors.propertyCity && (
              <p className="text-xs text-danger flex items-center gap-1">
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              className={cn(
                'w-full px-4 py-2.5 rounded-xl border bg-white dark:bg-[#1a1a1c] text-neutral-900 dark:text-white placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all',
                errors.propertyZone ? 'border-danger/30' : 'border-neutral-200 dark:border-neutral-700'
              )}
            />
            {errors.propertyZone && (
              <p className="text-xs text-danger flex items-center gap-1">
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                className={cn(
                  'w-full pl-10 pr-4 py-2.5 rounded-xl border bg-white dark:bg-[#1a1a1c] text-neutral-900 dark:text-white placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all',
                  errors.monthlyRent ? 'border-danger/30' : 'border-neutral-200 dark:border-neutral-700'
                )}
              />
            </div>
            {errors.monthlyRent && (
        ...
        <div className="space-y-3">
          ...
          <div className="relative">
            <input
              ...
              className="w-full px-4 py-3 pr-12 rounded-xl border border-border bg-background text-foreground text-lg font-semibold focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all tabular-nums"
              placeholder="10"
            />
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-[#1a1a1c] text-neutral-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all"
            />
          </div>
        </div>
      </div>
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          ...
          <button
            type="button"
            onClick={addItem}
            className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-md bg-primary-soft text-primary text-sm font-medium hover:bg-primary-soft transition-colors"
          >
                  ...
                  <div className="flex-1 grid grid-cols-1 sm:grid-cols-3 gap-3">
                    ...
                    <div className="sm:col-span-2">
                      <input
                        ...
                        className="w-full px-3 py-2 rounded-md border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-[#141416] text-neutral-900 dark:text-white placeholder-neutral-400 text-sm focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
                      />
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                      <input
                        ...
                        className="w-20 px-3 py-2 rounded-md border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-[#141416] text-neutral-900 dark:text-white text-sm text-center focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
                      />
                    ...
                    <div className="relative">
                      <select
                        ...
                        className="w-full px-3 py-2 rounded-md border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-[#141416] text-neutral-900 dark:text-white text-sm appearance-none cursor-pointer focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
                      >
                    ...
                    <input
                      ...
                      className="sm:col-span-2 px-3 py-2 rounded-md border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-[#141416] text-neutral-900 dark:text-white placeholder-neutral-400 text-sm focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
                    />
                  </div>
  ...
  const SectionHeader = ({ title, step }: { title: string; step: number }) => (
    <div className="flex items-center justify-between mb-3">
      ...
      <button
        ...
        className="inline-flex items-center gap-1 px-2 py-1 rounded text-xs font-medium text-primary hover:bg-primary-soft transition-colors"
      >
